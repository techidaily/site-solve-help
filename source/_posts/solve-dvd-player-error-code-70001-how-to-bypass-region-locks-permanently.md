...
**Step 3.** Back to the main interface, check the Safe Mode which will avoid any unexpected crashes/ripping errors that you may see with other tools. Then click Run. 
